const About = () => {
	return (
		<section className='max-w-6xl mx-auto py-16 space-y-4'>
			<h1 className='text-3xl font-bold'>About Super Estate</h1>
			<p>
				Super Estate is a leading real estate agency that specializes in helping
